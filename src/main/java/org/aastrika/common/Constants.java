...
public class Constants {
    ...
    public static final String API_USER_BULK_UPLOAD =
            "api.user.bulk.upload";

    public static final String API_USER_BULK_UPLOAD_STATUS =
            "api.user.bulk.upload.status";

    public static final String TABLE_USER_BULK_UPLOAD =
            "user_bulk_upload";
