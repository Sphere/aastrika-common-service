...
public class SunbirdApiRespContent {
    ...
    private List<SunbirdApiRespOrganisation> organisations;
    ...
    public List<SunbirdApiRespOrganisation> getOrganisations() {
        return organisations;
    }

    public void setOrganisations(List<SunbirdApiRespOrganisation> organisations) {
